...
Source0  : https://cpan.metacpan.org/authors/id/M/MS/MSCHOUT/Text-Template-1.55.tar.gz
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.1/Text/Template.pm
/usr/lib/perl5/vendor_perl/5.28.1/Text/Template/Preprocess.pm
